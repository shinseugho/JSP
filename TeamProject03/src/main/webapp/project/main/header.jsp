					...
					<ul class="nav navbar-nav flex-child-menu menu-left">
						...
						<li class="dropdown first">
							...
							<ul class="dropdown-menu level1">
								...
								<li><a href="../celeb/celebgrid.do">celebrity grid</a></li>
								<li><a href="../celeb/celeblist.do">celebrity list</a></li>
						...
						<li class="dropdown first">
							...
							<ul class="dropdown-menu level1">
								<li><a href="../mypage/userFavoriteGrid.do">My Favorite Grid</a></li>
								<li><a href="../mypage/userFavoriteList.do">My Favorite List</a></li>
								<li><a href="../mypage/userProfile.do">My Profile</a></li>
								<li class="it-last"><a href="../mypage/userRate.do">My Rate</a></li>
							</ul>
						</li>
					</ul>
