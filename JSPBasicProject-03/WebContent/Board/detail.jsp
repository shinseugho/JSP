...
$(function() {
	...
	/*
		...
		=> getter: <a>bbb</a>   					$('a').text()
		=> setter: <a></a>							$('a').text("bbb")
		=> <a href="kkk" id="k">					$('#k').attr("href")
		=> <input type="text" id="p" value="kkk"> 	$('#p').val()
		=> <td><span>ooo</span></td> 				$('td span').text() 또는 $('td').text()
	*/
	...
	<div class="container">
		...
		<div class="row">
			<table class="table table-hover">
				...
				<tr>
					<td colspan="4" class="text-left" valign="top" heigh="200">
