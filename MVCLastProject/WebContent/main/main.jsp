...
<div class="wrapper row1">
  <header id="header" class="clear"> 
    ...
    <div id="logo" class="fl_left">
      <h1><a href="index.html">SIST Seoul Travel</a></h1>
    </div>
    <!-- ################################################################################################ -->
...
<div class="row1">
  	<div id="clear" style="margin-left:1400px">
  		<input type="text" size="10px" class="input-sm" placeholder="ID" style="display:inline-block;">
  		<input type="password" size="10px" class="imput-sm" placeholder="Password" style="display:inline-block;">
