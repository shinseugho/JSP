...
<body>
	<div class="container">
		...
		<div class="row">
			<table class="table">
				<tr>
					<td width="30%" class="text-center" rowspan="7"><img src="${vo.poster }" width="100%"></td>
				...
				<tr>
					...
					<td colspan="3" class="text-right">
						<a href="javascript:history.back()" class="btn btn-sm btn-default">목록</a>
					</td>
				</tr>
			</table>
		</div>
